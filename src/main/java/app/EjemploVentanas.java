...
public class EjemploVentanas extends Application {
	...
	public void abrirVentanaModal(Stage stage) {
		...
		// Para bloquear a la ventana padre hay que
		// definir quien es el padre
		// con initowner y poner la modalidad
	...
	// Funcion que abre la ventana del formulario de
	// contacto
	...
	public void mostrarAlerta(AlertType tipoAlerta) {
		...
		if (tipoAlerta == Alert.AlertType.CONFIRMATION) {
			...
			// Al mostrar la ventana, esta nos devuelve
			// el tipo de boton que se ha pulsado
